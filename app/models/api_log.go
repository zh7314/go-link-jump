...
type APILog struct {
	...
	CreateAt     time.Time `gorm:"column:create_at;not null;comment:创建时间" json:"create_at"`
	UpdateAt     time.Time `gorm:"column:update_at;not null;comment:更新时间" json:"update_at"`
